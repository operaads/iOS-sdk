...
static NSString *const rewardedInterstitialPlacementId = @"s14496445187904";
static NSString *const appOpenPlacementId = @"s14496438551808";
...
+ (NSString *)getPlacementIdWithAdFormat:(AdFormat)adFormat forceVideo:(BOOL)forceVideo {
    ...
    switch (adFormat) {
        ...
        case AdFormatRewardedInterstitial:
            return rewardedInterstitialPlacementId;
        case AdFormatAppOpen:
