...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger ILLEGAL_API_CALL;)
+ (NSInteger)ILLEGAL_API_CALL SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger INVALID_PARAMETER;)
+ (NSInteger)INVALID_PARAMETER SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger ASSETS_ERROR;)
+ (NSInteger)ASSETS_ERROR SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger NO_FILL;)
+ (NSInteger)NO_FILL SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger SDK_INITIALIZATION_ERROR;)
+ (NSInteger)SDK_INITIALIZATION_ERROR SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger SHOW_AD_REUSED;)
+ (NSInteger)SHOW_AD_REUSED SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger SHOW_AD_NOT_FOREGROUND;)
+ (NSInteger)SHOW_AD_NOT_FOREGROUND SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger SHOW_AD_INVALIDATED;)
+ (NSInteger)SHOW_AD_INVALIDATED SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger SHOW_AD_START_ACTIVITY_ERROR;)
+ (NSInteger)SHOW_AD_START_ACTIVITY_ERROR SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger BID_RESP_DEBUGGING_NOT_ALLOWED;)
+ (NSInteger)BID_RESP_DEBUGGING_NOT_ALLOWED SWIFT_WARN_UNUSED_RESULT;
...
/// 加载广告
- (void)loadAd;
/// Load banner ad for client-side bidding (C2S).
- (void)loadC2SBid;
/// 暂停广告（在视图不可见时调用）
- (void)pause;
/// 恢复广告（在视图可见时调用）
...
SWIFT_ENUM_FWD_DECL(NSInteger, SKOverlayDisplayStrategy)
@class UIWindowScene;
/// SKAdNetwork 管理器 - 处理广告归因和转化值更新
SWIFT_CLASS("_TtC8OpAdxSdk23OpAdxSKAdNetworkManager")
@interface OpAdxSKAdNetworkManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) OpAdxSKAdNetworkManager * _Nonnull shared;)
+ (OpAdxSKAdNetworkManager * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// 是否启用 SKAdNetwork 支持（默认开启）
/// Source App 端注册 impression 不会与 MMP（AppsFlyer/Adjust）冲突，
/// MMP 工作在 Advertised App 端管理 conversion value。
@property (nonatomic) BOOL isEnabled;
/// 是否启用调试日志
@property (nonatomic) BOOL enableDebugLog;
/// 是否启用 StoreKit-Rendered Ad 功能（SKOverlay/SKStoreProductViewController，fidelity=1）。
/// 如果为 false，点击时直接打开外部链接，不通过 StoreKit 渲染。
...
/// 开始 SKAN View-Through 归因 impression（广告可见时调用，使用 fidelity=0 签名）
...
/// 显示 StoreKit-Rendered Ad（SKOverlay 携带 SKAN fidelity=1 签名参数）
/// \param skAdNetworkData SKAdNetwork 数据字典
///
/// \param windowScene 用于显示 overlay 的 window scene（iOS 13+）
///
/// \param fallback SKOverlay 异步加载失败时的降级回调（打开点击链接）
///
///
/// returns:
/// 是否成功发起 SKOverlay 展示请求
- (BOOL)presentOverlayWith:(NSDictionary<NSString *, id> * _Nonnull)skAdNetworkData in:(UIWindowScene * _Nullable)windowScene fallback:(void (^ _Nullable)(void))fallback SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=14.0);
/// 关闭当前显示的 SKOverlay
- (void)dismissOverlay SWIFT_AVAILABILITY(ios,introduced=14.0);
/// 使用 SKStoreProductViewController 展示应用内 App Store 页面，并携带 SKAN fidelity=1 签名参数
/// 这是 StoreKit-Rendered Ad 的另一种实现方式，适用于广告点击时在应用内展示 App Store
/// \param skAdNetworkData SKAdNetwork 数据字典
///
/// \param viewController 用于 present 的视图控制器
///
/// \param fallback loadProduct 失败时的降级回调（打开外部 URL）
///
- (void)presentStoreProductWith:(NSDictionary<NSString *, id> * _Nonnull)skAdNetworkData from:(UIViewController * _Nonnull)viewController fallback:(void (^ _Nullable)(void))fallback SWIFT_AVAILABILITY(ios,introduced=14.0);
@end

@class SKStoreProductViewController;
@interface OpAdxSKAdNetworkManager (SWIFT_EXTENSION(OpAdxSdk)) <SKStoreProductViewControllerDelegate>
...
@interface OpAdxSKAdNetworkManager (SWIFT_EXTENSION(OpAdxSdk)) <SKOverlayDelegate>
...
/// 默认使用 fidelities 数组中的第一个签名
/// \param dictionary 包含签名参数的字典
///
///
/// returns:
/// OpAdxSKAdNetworkSignatureData 对象，如果参数不完整则返回 nil
+ (OpAdxSKAdNetworkSignatureData * _Nullable)createSignatureDataFrom:(NSDictionary<NSString *, id> * _Nonnull)dictionary SWIFT_WARN_UNUSED_RESULT;
/// 从字典创建指定 fidelity 类型的签名数据
/// \param dictionary 包含签名参数的字典
///
/// \param fidelityType 指定的 fidelity 类型（0=view-through, 1=StoreKit-rendered）
///
///
/// returns:
/// OpAdxSKAdNetworkSignatureData 对象，如果参数不完整或找不到对应 fidelity 则返回 nil
+ (OpAdxSKAdNetworkSignatureData * _Nullable)createSignatureDataFrom:(NSDictionary<NSString *, id> * _Nonnull)dictionary fidelityType:(NSInteger)fidelityType SWIFT_WARN_UNUSED_RESULT;
@end

/// SKAdNetwork 签名参数数据模型
SWIFT_CLASS("_TtC8OpAdxSdk29OpAdxSKAdNetworkSignatureData")
@interface OpAdxSKAdNetworkSignatureData : NSObject
/// 广告网络标识符
@property (nonatomic, readonly, copy) NSString * _Nonnull networkIdentifier;
/// 广告活动标识符 (2-100)
@property (nonatomic, readonly, strong) NSNumber * _Nonnull campaignIdentifier;
/// 应用 App Store ID
@property (nonatomic, readonly, strong) NSNumber * _Nonnull destinationAppStoreIdentifier;
/// 随机数 (nonce)
@property (nonatomic, readonly, copy) NSString * _Nonnull nonce;
/// 源应用 App Store ID
@property (nonatomic, readonly, strong) NSNumber * _Nonnull sourceAppStoreIdentifier;
/// 时间戳
...
/// 版本号 (可选，SKAdNetwork 2.2+)
@property (nonatomic, readonly, copy) NSString * _Nullable version;
/// 源标识符 (可选，SKAdNetwork 4.0+)
@property (nonatomic, readonly, strong) NSNumber * _Nullable sourceIdentifier;
- (nonnull instancetype)initWithNetworkIdentifier:(NSString * _Nonnull)networkIdentifier campaignIdentifier:(NSNumber * _Nonnull)campaignIdentifier destinationAppStoreIdentifier:(NSNumber * _Nonnull)destinationAppStoreIdentifier nonce:(NSString * _Nonnull)nonce sourceAppStoreIdentifier:(NSNumber * _Nonnull)sourceAppStoreIdentifier timestamp:(NSNumber * _Nonnull)timestamp signature:(NSString * _Nonnull)signature version:(NSString * _Nullable)version sourceIdentifier:(NSNumber * _Nullable)sourceIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
/// returns:
/// 当前设置的 iOS App ID，如果未设置则返回 nil
- (NSString * _Nullable)getCurrentIOSAppId SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
